...
def load_official_manifest_union(review_dir: Path) -> tuple[dict[str, tuple[int, str, dict]], set[str]]:
    ...
    # 7B.48..25: blocos recentes — mesma lógica auto-detect plain/union.
    for _bn, _prio in (
        (48, PRIO_PASS1_B48),
        (47, PRIO_PASS1_B47),
        (46, PRIO_PASS1_B46),
