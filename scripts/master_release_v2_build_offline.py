...
# 7B.70: B70 acima de B69 — liquidação final cauda visível (22 SHAs)
PRIO_PASS1_B70 = -66
# 7B.69: B69 acima de B68 — penúltima raspagem (~25 SHAs)
PRIO_PASS1_B69 = -65
# 7B.68: B68 acima de B67 — exaurir cauda física (~28 SHAs)
PRIO_PASS1_B68 = -64
# 7B.67: B67 acima de B66 — cauda física final (~31 SHAs)
PRIO_PASS1_B67 = -63
# 7B.66: B66 acima de B65 — raspagem final inéditos + pendências cauda
PRIO_PASS1_B66 = -62
# 7B.65: B65 acima de B64 — sidecar ventiladores + cauda física
PRIO_PASS1_B65 = -61
# 7B.64: B64 acima de B63 — reprocessamento JSON (ventiladores 2) + cauda
PRIO_PASS1_B64 = -60
# 7B.63: B63 acima de B62 — recuperação infra + cauda
PRIO_PASS1_B63 = -59
...
PRIO_PASS1_B60 = -56
# 7B.59: B59 acima de B58 — cauda do acervo
PRIO_PASS1_B59 = -55
# 7B.58: B58 acima de B57 — pós-milhar
PRIO_PASS1_B58 = -54
# 7B.57: B57 acima de B56 — era pós-milhar
PRIO_PASS1_B57 = -53
# 7B.56: B56 acima de B55 — marco histórico 1000 OFICIAL
PRIO_PASS1_B56 = -52
# 7B.55: B55 acima de B54 — contagem regressiva 1000
PRIO_PASS1_B55 = -51
# 7B.54: B54 acima de B53 — contagem regressiva 1000
PRIO_PASS1_B54 = -50
# 7B.53: B53 acima de B52 — contagem regressiva 1000
PRIO_PASS1_B53 = -49
# 7B.52: B52 acima de B51 — contagem regressiva 1000
PRIO_PASS1_B52 = -48
...
PRIO_PASS1_B49 = -45
# 7B.48: B48 acima de B47 — rumo ao marco 900 OFICIAL
PRIO_PASS1_B48 = -44
# 7B.47: B47 acima de B46 — inéditos físicos (slice 2)
PRIO_PASS1_B47 = -43
...
def load_official_manifest_union(review_dir: Path) -> tuple[dict[str, tuple[int, str, dict]], set[str]]:
    ...
    # 7B.70..25: blocos recentes — mesma lógica auto-detect plain/union.
    for _bn, _prio in (
        (70, PRIO_PASS1_B70),
        (69, PRIO_PASS1_B69),
        (68, PRIO_PASS1_B68),
...
_PASS1_V2_RECONCILED_TAG_RE = re.compile(r"^PASS1_V2_BLOCO_\d{2}_RECONCILIADO$")


def _is_pass1_v2_reconciled_tag(ftag: str) -> bool:
    """Fonte PASS1-v2 reconciliada: indulto regras b/c (histórico manual / NO_AUTO)."""
    return bool(_PASS1_V2_RECONCILED_TAG_RE.match(_t(ftag)))
...
def main() -> int:
    ...
    def apply_abc(ar: str, sh: str, ftag: str = "") -> list[str]:
        ...
        if sh in mutirao_amnesty_shas:
            return []
        # Resgate PASS1 (B36+) e esteira PASS1-v2 reconciliada: indulto historico NO_AUTO (c) e manual_review (b).
        rescue_bypass_bc = (
            ftag in rescue_amnesty_tags
            or sh in rescue_amnesty_shas
            or _is_pass1_v2_reconciled_tag(ftag)
        )
    ...
    fase_human = {
        ...
        PHASE_7B47: "7B.47 — B47 (inéditos físicos — slice 2)",
        ...
        PHASE_7B52: "7B.52 — B52 (contagem regressiva 1000)",
        PHASE_7B53: "7B.53 — B53 (contagem regressiva 1000)",
        PHASE_7B54: "7B.54 — B54 (contagem regressiva 1000)",
        PHASE_7B55: "7B.55 — B55 (contagem regressiva 1000)",
        PHASE_7B56: "7B.56 — B56 (marco histórico 1000 OFICIAL)",
        PHASE_7B57: "7B.57 — B57 (pós-milhar, expandindo base)",
        PHASE_7B58: "7B.58 — B58 (pós-milhar, expandindo base)",
        ...
        PHASE_7B70: "7B.70 — B70 (liquidação final cauda visível)",
        PHASE_7B69: "7B.69 — B69 (penúltima raspagem cauda)",
        PHASE_7B68: "7B.68 — B68 (exaurir cauda física restante)",
        PHASE_7B67: "7B.67 — B67 (cauda física final)",
        PHASE_7B66: "7B.66 — B66 (raspagem final inéditos + pendências cauda)",
        PHASE_7B65: "7B.65 — B65 (sidecar ventiladores 1–3 + cauda física)",
        PHASE_7B64: "7B.64 — B64 (parser JSON ventiladores 2 + cauda)",
        PHASE_7B63: "7B.63 — B63 (recuperação infra ventiladores + cauda)",
    }[phase_slug]
    ...
    expect_total_window = {
        ...
        PHASE_7B46: (869, 890),
        # 7B.47: baseline pós-B46 (882 OFICIAL) + até 14 inéditos.
        PHASE_7B47: (882, 905),
        # 7B.48: baseline pós-B47 (894 OFICIAL) — meta histórica ≥900.
        PHASE_7B48: (890, 915),
        # 7B.49: baseline pós-B48 (906 OFICIAL) — consolidar clube 900+.
        PHASE_7B49: (900, 925),
        # 7B.50: baseline pós-B49 (918 OFICIAL) — marco bloco 50.
        PHASE_7B50: (915, 935),
        # 7B.51: baseline pós-B50 (930 OFICIAL) — meta 1000.
        PHASE_7B51: (925, 945),
        # 7B.52: baseline pós-B51 (942 OFICIAL).
        PHASE_7B52: (935, 955),
        # 7B.53: baseline pós-B52 (954 OFICIAL).
        PHASE_7B53: (945, 965),
        # 7B.54: baseline pós-B53 (966 OFICIAL).
        PHASE_7B54: (960, 980),
        # 7B.55: baseline pós-B54 (978 OFICIAL).
        PHASE_7B55: (970, 990),
        # 7B.56: baseline pós-B55 (989 OFICIAL) — meta histórica ≥1000.
        PHASE_7B56: (980, 1010),
        ...
        # 7B.60: baseline pós-mutirão (1020 OFICIAL).
        ...
        # 7B.63: baseline pós-B62 (1036 OFICIAL).
        PHASE_7B70: (1050, 1090),
        PHASE_7B69: (1045, 1085),
        PHASE_7B68: (1045, 1080),
        PHASE_7B67: (1045, 1075),
        PHASE_7B66: (1040, 1070),
        PHASE_7B65: (1035, 1065),
        PHASE_7B64: (1030, 1060),
        PHASE_7B63: (1025, 1055),
    }
    ...
    summary = {
        ...
        "sanidade": {
            ...
            "PASS1_V2_B70_OFICIAL": br_fonte_of.get("PASS1_V2_BLOCO_70_RECONCILIADO", 0),
            "PASS1_V2_B69_OFICIAL": br_fonte_of.get("PASS1_V2_BLOCO_69_RECONCILIADO", 0),
            "PASS1_V2_B68_OFICIAL": br_fonte_of.get("PASS1_V2_BLOCO_68_RECONCILIADO", 0),
            "PASS1_V2_B67_OFICIAL": br_fonte_of.get("PASS1_V2_BLOCO_67_RECONCILIADO", 0),
            "PASS1_V2_B66_OFICIAL": br_fonte_of.get("PASS1_V2_BLOCO_66_RECONCILIADO", 0),
            "PASS1_V2_B65_OFICIAL": br_fonte_of.get("PASS1_V2_BLOCO_65_RECONCILIADO", 0),
            "PASS1_V2_B64_OFICIAL": br_fonte_of.get("PASS1_V2_BLOCO_64_RECONCILIADO", 0),
            "PASS1_V2_B63_OFICIAL": br_fonte_of.get("PASS1_V2_BLOCO_63_RECONCILIADO", 0),
            ...
            "PASS1_V2_B58_OFICIAL": br_fonte_of.get("PASS1_V2_BLOCO_58_RECONCILIADO", 0),
            "PASS1_V2_B57_OFICIAL": br_fonte_of.get("PASS1_V2_BLOCO_57_RECONCILIADO", 0),
            "PASS1_V2_B56_OFICIAL": br_fonte_of.get("PASS1_V2_BLOCO_56_RECONCILIADO", 0),
            "PASS1_V2_B55_OFICIAL": br_fonte_of.get("PASS1_V2_BLOCO_55_RECONCILIADO", 0),
            "PASS1_V2_B54_OFICIAL": br_fonte_of.get("PASS1_V2_BLOCO_54_RECONCILIADO", 0),
            "PASS1_V2_B53_OFICIAL": br_fonte_of.get("PASS1_V2_BLOCO_53_RECONCILIADO", 0),
            "PASS1_V2_B52_OFICIAL": br_fonte_of.get("PASS1_V2_BLOCO_52_RECONCILIADO", 0),
            ...
            "PASS1_V2_B47_OFICIAL": br_fonte_of.get("PASS1_V2_BLOCO_47_RECONCILIADO", 0),
