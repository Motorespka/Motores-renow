...
def load_official_manifest_union(review_dir: Path) -> tuple[dict[str, tuple[int, str, dict]], set[str]]:
    ...
    # 7B.40..25: blocos recentes — mesma lógica auto-detect plain/union.
    for _bn, _prio in (
        (40, PRIO_PASS1_B40),
        (39, PRIO_PASS1_B39),
        (38, PRIO_PASS1_B38),
