...
def load_official_manifest_union(review_dir: Path) -> tuple[dict[str, tuple[int, str, dict]], set[str]]:
    ...
    # 7B.57..25: blocos recentes — mesma lógica auto-detect plain/union.
    for _bn, _prio in (
        (57, PRIO_PASS1_B57),
        (56, PRIO_PASS1_B56),
        (55, PRIO_PASS1_B55),
