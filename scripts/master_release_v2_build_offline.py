...
def load_official_manifest_union(review_dir: Path) -> tuple[dict[str, tuple[int, str, dict]], set[str]]:
    ...
    # 7B.47..25: blocos recentes — mesma lógica auto-detect plain/union.
    for _bn, _prio in (
        (47, PRIO_PASS1_B47),
        (46, PRIO_PASS1_B46),
        (45, PRIO_PASS1_B45),
