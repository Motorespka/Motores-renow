...
def load_official_manifest_union(review_dir: Path) -> tuple[dict[str, tuple[int, str, dict]], set[str]]:
    ...
    # 7B.59..25: blocos recentes — mesma lógica auto-detect plain/union.
    for _bn, _prio in (
        (59, PRIO_PASS1_B59),
        (58, PRIO_PASS1_B58),
        (57, PRIO_PASS1_B57),
