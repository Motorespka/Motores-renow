...
def load_official_manifest_union(review_dir: Path) -> tuple[dict[str, tuple[int, str, dict]], set[str]]:
    ...
    # 7B.64..25: blocos recentes — mesma lógica auto-detect plain/union.
    for _bn, _prio in (
        (64, PRIO_PASS1_B64),
        (63, PRIO_PASS1_B63),
        (62, PRIO_PASS1_B62),
