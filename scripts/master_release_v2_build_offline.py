...
def load_official_manifest_union(review_dir: Path) -> tuple[dict[str, tuple[int, str, dict]], set[str]]:
    ...
    # 7B.66..25: blocos recentes — mesma lógica auto-detect plain/union.
    for _bn, _prio in (
        (66, PRIO_PASS1_B66),
        (65, PRIO_PASS1_B65),
        (64, PRIO_PASS1_B64),
