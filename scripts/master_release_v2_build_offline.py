...
def load_official_manifest_union(review_dir: Path) -> tuple[dict[str, tuple[int, str, dict]], set[str]]:
    ...
    # 7B.39..25: blocos recentes — mesma lógica auto-detect plain/union.
    for _bn, _prio in (
        (39, PRIO_PASS1_B39),
        (38, PRIO_PASS1_B38),
        (37, PRIO_PASS1_B37),
