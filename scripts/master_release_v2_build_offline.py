...
def load_official_manifest_union(review_dir: Path) -> tuple[dict[str, tuple[int, str, dict]], set[str]]:
    ...
    # 7B.55..25: blocos recentes — mesma lógica auto-detect plain/union.
    for _bn, _prio in (
        (55, PRIO_PASS1_B55),
        (54, PRIO_PASS1_B54),
        (53, PRIO_PASS1_B53),
