"""
Holograma interativo na consulta: arraste para girar; estilo por preset (IP/carcaca).
"""
...
<style>
  * {{ box-sizing: border-box; }}
  ...
  .fins {{
    position:absolute; inset:9px 12px; display:flex; gap:4px;
  }}
  .holo-fin {{
...
<body>
  <div class="wrap holo-preset--{html.escape(preset)}" id="{hid_attr}">
    ...
    <div class="hint">Arraste na area para girar o modelo</div>
...
"""
    ...
    try:
        ...
        components.html(doc, height=310, scrolling=False)
    except Exception:
        st.caption(
