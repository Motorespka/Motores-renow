...
def _consulta_paid_body_impl(ctx, admin_user: bool) -> None:
    ...
    # Filtros à esquerda; lista + cartões (holograma) na coluna principal — tudo na mesma coluna à direita
    # para o mesmo encadeamento Streamlit que antes ocupava a área principal a largura quase total.
