    ...
    for m in motores:
        ...
        <div style="margin-top:-245px; margin-bottom:50px; padding:20px; pointer-events:none; position:relative; z-index:5;">
            <div style="display:flex; justify-content:space-between; align-items:start;">
                ...
                <div style="background:rgba(16,185,129,0.2); color:#10b981; padding:4px 12px; border-radius:20px; font-size:0.75rem; font-weight:bold; border:1px solid #10b981;">{fases}</div>
            </div>
        ...
        if st.session_state.detalhes_visiveis.get(key_det):
            ...
            st.markdown("""<div style="display:grid; grid-template-columns: 1fr 1fr; gap:10px; background:rgba(255,255,255,0.05); padding:15px; border-radius:8px; font-family:monospace; font-size:0.85rem;">
                <div><span style="color:#4d4dff">●</span> 1: AZUL</div><div><span style="color:#ffffff">●</span> 2: BRANCO</div>
                <div><span style="color:#ff8c00">●</span> 3: LARANJA</div><div><span style="color:#ffff00">●</span> 4: AMARELO</div>
                <div><span style="color:#888888">●</span> 5: PRETO</div><div><span style="color:#ff4d4d">●</span> 6: VERMELHO</div>
            ...
            with t_liga:
                if "MONO" in fases:
                    st.code("110V: L1(1,3,5) - L2(2,4,6)\n220V: L1(1) - L2(4) | Unir: 2,3,5,6")
                else:
                    st.code("∆ 220V: L1(1,6) L2(2,4) L3(3,5)\nY 380V: L1(1) L2(2) L3(3) | Unir: 4,5,6")
