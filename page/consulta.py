...
try:
    ...
    # ✅ IMPORTANTE: Busca o diagnóstico que está dentro da pasta 'page'
    from page import diagnostico 
except Exception as e:
    # Se falhar as importações do core, o app não quebra
    pass
...
# =================================================================
# 3. BUSCA ANTIGA (MANTIDA COMO FALLBACK)
# =================================================================
...
# =================================================================
# 5. TELA PRINCIPAL (SHOW)
# =================================================================
def show(supabase):

    # Carregamento do CSS se existir
    ...
    for m in motores:  
        ...
        if st.session_state.detalhes_visiveis.get(key_det):  
            ...
            # ✅ NOVA INTEGRAÇÃO: DIAGNÓSTICO RÁPIDO
            with st.expander("🧠 Diagnóstico Rápido"):
                try:
                    # Chama a função que está no seu page/diagnostico.py
