## Resumo batch rebobinagem (2026-05-14 19:57:29)

- **input**: `C:\Users\micke\Desktop\O rebobinador\_extraidos_motor`
- **work_queue_csv**: `exports\review\pass1_v2_block_29.csv`
- **output_tag**: `extraidos_motor_fase7a_pass1_v2_block_29_flash`

> **AVISO — limite de ficheiros:** Nao foi passado `--limit` na linha de comando. Neste modo, o programa aplica o **default 20** (apenas as primeiras 20 entradas da fila). Para 100, use `--limit 100`. Para nao cortar a fila, use `--limit 0`.

- **dry-run**: `False` (sem chamadas Gemini à API)
- **processados**: `14`
- **cache respostas**: `C:\Users\micke\Desktop\O rebobinador\Motores-renow\logs\extraidos_motor_fase7a_pass1_v2_block_29_flash_gemini_cache`

### Fontes

- tentativas pipeline local (PDF texto / Tesseract / EasyOCR): 14
- com texto local não vazio: 14
