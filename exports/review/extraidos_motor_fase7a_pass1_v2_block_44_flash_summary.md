## Resumo batch rebobinagem (2026-05-16 17:14:16)

- **input**: `C:\Users\micke\Desktop\O rebobinador\_extraidos_motor`
- **work_queue_csv**: `exports/review/pass1_v2_block_44.csv`
- **output_tag**: `extraidos_motor_fase7a_pass1_v2_block_44_flash`
- **dry-run**: `False` (sem chamadas Gemini à API)
- **processados**: `14`
- **cache respostas**: `C:\Users\micke\Desktop\O rebobinador\Motores-renow\logs\extraidos_motor_fase7a_pass1_v2_block_44_flash_gemini_cache`

### Fontes

- tentativas pipeline local (PDF texto / Tesseract / EasyOCR): 15
- com texto local não vazio: 13
...
- UQ_7 | status=ok | eligible_end=1 | calls=1 | ok=1 | quota=0 | errors=1 | cooldown= | blocked=
