## Resumo batch rebobinagem (2026-05-14 22:11:12)

- **input**: `C:\Users\micke\Desktop\O rebobinador\_extraidos_motor`
- **work_queue_csv**: `exports\review\pass1_v2_block_34.csv`
- **output_tag**: `extraidos_motor_fase7a_pass1_v2_block_34_flash`
- **dry-run**: `False` (sem chamadas Gemini à API)
- **processados**: `14`
- **cache respostas**: `C:\Users\micke\Desktop\O rebobinador\Motores-renow\logs\extraidos_motor_fase7a_pass1_v2_block_34_flash_gemini_cache`

### Fontes

- tentativas pipeline local (PDF texto / Tesseract / EasyOCR): 18
- com texto local não vazio: 10
...
- drive-download-20260408T000443Z-3-001_253069\REGULADOR CR.pdf: baixa_confianca_local missing=[]
