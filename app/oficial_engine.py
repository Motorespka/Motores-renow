    ...
    *,
    ...
    row_jsonl = {
        ...
        "resultado": {
            ...
            "passo_principal": payload.get("passo_principal") or payload.get("passo", ""),
            "passo_auxiliar": payload.get("passo_auxiliar", ""),
            "fio_auxiliar": str(payload.get("fio_auxiliar", "")),
            "espiras_auxiliar": str(payload.get("espiras_auxiliar", "")),
            "capacitor_uf": str(payload.get("capacitor_uf", "")),
            "tipo_motor": payload.get("tipo_motor", ""),
